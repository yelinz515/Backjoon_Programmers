...
<p style="user-select: auto;">동물 보호소에 들어온 동물 중 아픈 동물<sup id="fnref1" style="user-select: auto;"><a href="#fn1" style="user-select: auto;">1</a></sup>의 아이디와 이름을 조회하는 SQL 문을 작성해주세요. 이때 결과는 아이디 순으로 조회해주세요. </p>
...
<p style="user-select: auto;">이 중 아픈 동물은 Miller와 Cherokee입니다. 따라서 SQL문을 실행하면 다음과 같이 나와야 합니다. </p>
<table class="table" style="user-select: auto;">
        <thead style="user-select: auto;"><tr style="user-select: auto;">
<th style="user-select: auto;">ANIMAL_ID</th>
<th style="user-select: auto;">NAME</th>
...
<p style="user-select: auto;"><code style="user-select: auto;">INTAKE_CONDITION</code>이 Sick 인 경우를 뜻함&nbsp;<a href="#fnref1" style="user-select: auto;">↩</a></p>
</li>
